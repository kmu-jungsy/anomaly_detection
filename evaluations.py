...
def eval_det_loc(det_auroc_obs, loc_auroc_obs, loc_pro_obs, epoch,
    ...
    # check whether there is any real pixel-level anomaly mask
    has_pixel_labels = np.any(gt_mask)
    ...
    if has_pixel_labels:
        ...
        loc_auroc, best_loc_auroc = None, False
        loc_pro_auc, best_loc_pro = None, False
        print("No pixel-level ground-truth masks found. Skip localization metrics.")
